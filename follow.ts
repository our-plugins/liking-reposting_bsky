...
// Configuration
const MAX_FOLLOWS = 3000; // Max users to follow
...
async function main() {
  ...
  // Optionally save fetched users to file
  ...
  await followAccountsWithRateLimits(agent, notFollowingYet, isConservative);
...
// Follow accounts with rate limit handling
async function followAccountsWithRateLimits(agent: BskyAgent, toFollow: UserRecord[], isConservative: boolean): Promise<void> {
